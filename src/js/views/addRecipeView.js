  ...
  _generateMarkup() {
    return `
      <div class="upload__column">
        ...
        <label>Title</label>
        <input value="TEST43" required name="title" type="text" />
        <label>URL</label>
        <input value="TEST43" required name="sourceUrl" type="text" />
        <label>Image URL</label>
        <input value="TEST43" required name="image" type="text" />
        <label>Publisher</label>
        <input value="TEST43" required name="publisher" type="text" />
